...
public class Action extends Fragment {
    ...
    private final String JSON_URL = "https://jobtanks.com/phpgame/api/product/action.php";
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0 ; i < response.length(); i++ ) {
                    ...
                    try {
                        ...
                        anime.setWebsite_link(jsonObject.getString("action_link"));
                        anime.setWebsite_logo(jsonObject.getString("action_logo"));
                        lstAnime.add(anime);
