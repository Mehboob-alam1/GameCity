...
public class Zombie extends Fragment {
    ...
    private final String JSON_URL = "https://jobtanks.com/phpgame/api/product/zombie.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_zombie, container, false);
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0 ; i < response.length(); i++ ) {
                    ...
                    try {
                        ...
                        anime.setWebsite_link(jsonObject.getString("zombie_link"));
                        anime.setWebsite_logo(jsonObject.getString("zombie_logo"));
                        lstAnime.add(anime);
