...
public class Adventure extends Fragment {
    ...
    private final String JSON_URL = "https://jobtanks.com/phpgame/api/product/adventure.php";
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0 ; i < response.length(); i++ ) {
                    ...
                    try {
                        ...
                        anime.setWebsite_link(jsonObject.getString("adventure_link"));
                        anime.setWebsite_logo(jsonObject.getString("adventure_logo"));
                        lstAnime.add(anime);
