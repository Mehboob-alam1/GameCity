...
public class Racing extends Fragment {
    ...
    private final String JSON_URL = "https://jobtanks.com/phpgame/api/product/racing.php";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_racing, container, false);
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0 ; i < response.length(); i++ ) {
                    ...
                    try {
                        ...
                        anime.setWebsite_link(jsonObject.getString("racing_link"));
                        anime.setWebsite_logo(jsonObject.getString("racing_logo"));
                        lstAnime.add(anime);
