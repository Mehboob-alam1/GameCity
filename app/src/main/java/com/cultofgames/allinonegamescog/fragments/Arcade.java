...
public class Arcade extends Fragment {

    private final String JSON_URL = "https://jobtanks.com/phpgame/api/product/arcade.php";
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0 ; i < response.length(); i++ ) {
                    ...
                    try {
                        ...
                        anime.setWebsite_link(jsonObject.getString("arcade_link"));
                        anime.setWebsite_logo(jsonObject.getString("arcade_logo"));
                        lstAnime.add(anime);
